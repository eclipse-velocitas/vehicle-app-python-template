...
helm install vapp-chart $ROOT_DIRECTORY/deploy/VehicleApp/helm/ --values $ROOT_DIRECTORY/.vscode/scripts/runtime/k3d/VehicleApp_values.yml --wait --timeout 60s --debug
